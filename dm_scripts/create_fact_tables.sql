...
---##--fact tables for RRBS source systems---------------------------------------
...
CREATE TABLE ukdev.dm.fact_mno_uk_voicesms(
...
CREATE TABLE ukdev.dm.fact_mno_uk_gprs(
...
---#### LCR/SWITCH XCDA table :"fact_lcr_uk_xcda"--------------------------------

CREATE TABLE ukdev.dm.fact_lcr_uk_xcda(
...
CREATE TABLE ukdev.dm.fact_lcr_uk_xcdr(
...
CREATE TABLE ukdev.dm.fact_lcr_uk_xcds(
	sitecode varchar(3) NOT NULL,
	switchcode varchar(3) NOT NULL,
	calldate datetime NULL,
	sessionid_b varchar(32) NOT NULL,
...
CREATE TABLE ukdev.dm.fact_lcr_uk_xcdx(
...
---#### GGSN GPRS table :"fact_ggsn_uk_gprs"-------------------------------------

CREATE TABLE ukdev.dm.fact_ggsn_uk_gprs(
