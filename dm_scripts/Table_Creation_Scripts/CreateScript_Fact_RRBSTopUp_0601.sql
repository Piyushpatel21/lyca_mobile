...
,	cdr_dt	date encode raw  -- derived from data_termination_time
,	cdr_dt_num INT ENCODE ZSTD	-- derived from data_termination_time
...
,	contract_end_date	character varying(50) encode zstd
...
DISTSTYLE KEY
 ...
 sortkey
 (
cdr_dt,--recharge_date, this attribute is missing from raw file, but required in Daily Dash Board query
network_id,
operation_code
