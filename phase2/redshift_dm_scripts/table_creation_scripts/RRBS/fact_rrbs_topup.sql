...
(
    ...
    additional_channel_info                  varchar(50) encode zstd,
    autoflag                                 varchar(50) encode zstd,
    bundleexpirydate                         varchar(50) encode zstd,
    portinofferflag                          varchar(50) encode zstd,
    portinoffervaliditydays                  varchar(50) encode zstd,
    refunded_bundle_allowance_info           varchar(50) encode zstd,
    voucher_bundle_flag                      varchar(50) encode zstd,
    vouche_eligible_flag                     varchar(50) encode zstd,
    bundle_implicit_promo                    varchar(50) encode zstd,
    free_credit                              varchar(50) encode zstd,
    voucher_remaining_amount                 varchar(50) encode zstd,
    promo_code_type                          varchar(50) encode zstd,
    free_credit_offered_month                varchar(50) encode zstd,
    free_credit_type                         varchar(50) encode zstd,
    free_credit_promo_balance_validit_days   varchar(50) encode zstd,
    exempt_min_bal_checkexpiry_date          varchar(50) encode zstd,
    varibalepromoappliedinstallinfo          varchar(50) encode zstd,
    variablepromocardinfo                    varchar(50) encode zstd,
    new_exempt_in_bal_check_expiry_date      varchar(50) encode zstd,
    refund_transaction_id                    varchar(50) encode zstd,
    oba_cancellation_type                    varchar(50) encode zstd,
    oba_credit_consumed                      varchar(50) encode zstd,
    bypass_validation_for_special_bundles    varchar(50) encode zstd,
    campaign_flag                            varchar(50) encode zstd,
    campaign_key                             varchar(50) encode zstd,
