...
(
    ...
    recordtype                       varchar(100) encode zstd,
    ...
    pdppdntype                       varchar(100) encode zstd,
    servedpdppdnaddress              varchar(50) encode zstd,
    dynamicaddressflag               varchar(100) encode zstd,
    recordopeningtime                timestamp encode az64,
    duration                         integer encode az64,
    causeforrecclosing               varchar(150) encode zstd,
    diagnostics                      varchar(100) encode zstd,
    recordsequencenumber             varchar(100) encode zstd,
    ...
    rattype                          varchar(100) encode zstd,
