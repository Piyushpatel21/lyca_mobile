...
(
    sk_rrbs_sms                     bigint default default_identity(167485, 0, ('1,1'::character varying)::text) encode zstd,
    cdr_types                       smallint,
    network_id                      smallint,
    call_type                       smallint,
...
(
    sk_rrbs_sms                     bigint default default_identity(167488, 0, ('1,1'::character varying)::text) encode zstd,
    cdr_types                       smallint,
    network_id                      smallint,
    call_type                       smallint,
    plan_id                         integer encode az64,
...
(
    sk_rrbs_sms                     bigint default default_identity(167491, 0, ('1,1'::character varying)::text) encode zstd,
    cdr_types                       smallint,
    network_id                      smallint,
    call_type                       smallint,
    plan_id                         integer encode az64,
