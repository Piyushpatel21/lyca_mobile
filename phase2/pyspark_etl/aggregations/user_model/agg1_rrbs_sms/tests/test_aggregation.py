...
class TestAgg1RRBSSMS:
    ...
    sms_fact_location = 'assets/fact_rrbs_sms_2020-07-21.csv'
    ...
    def test_get_aggregation_instance(self, set_up):
        args = {
            ...
            "module": "rrbs",
            "sub_module": "sms",
            "configfile": "../configs/agg1_rrbs_sms_application_properties.json",
        ...
        print("Monthly: ", df_distinct_groupby_monthly.count())

        print("Yearly: ", df_distinct_groupby_yearly.count())
