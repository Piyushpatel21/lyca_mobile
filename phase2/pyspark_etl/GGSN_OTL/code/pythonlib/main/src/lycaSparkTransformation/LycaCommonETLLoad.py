...
def start_execution(args):
    ...
    try:
        ...
        tf.writetoDuplicateCDR(duplicateData, propColumns.get("tgtSchema"))
        tf.writetoDataMart(normalUnique, propColumns.get("tgtSchema"))
        tf.writetoLateCDR(lateUnique, propColumns.get("tgtSchema"))
        tf.writetoDataMart(lateUnique, propColumns.get("tgtSchema"))
