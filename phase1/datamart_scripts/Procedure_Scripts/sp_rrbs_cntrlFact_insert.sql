CREATE OR REPLACE PROCEDURE uk_rrbs_dm.sp_rrbs_cntrlFact_insert(p_filename "varchar",p_batchid "int4",p_srcsys "varchar",p_stgcount "int4")
	LANGUAGE plpgsql
AS $$ 	 	 	 	  
declare
...
insert into uk_rrbs_dm.ctrl_rrbs_fact (batch_id, filename, src_sys, stgRowCount) 
